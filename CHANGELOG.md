...
### Added
- `list_tasks` accepts a `tags` filter — comma-separated, AND-matched — so agents can narrow large vault queries instead of pulling every task and post-filtering.
